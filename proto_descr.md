...
<li><u>Синбаи (SeenBy)</u> - служебная информация сообщения, список номеров узлов, через которые прошло сообщение. Служит для отслеживания маршрута сообщения и предотвращения повторной пересылки.<br>
<br>
